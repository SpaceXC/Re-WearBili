package cn.spacexc.wearbili.remake.ui.player.audio
...
import cn.spacexc.wearbili.remake.ui.player.audio.ui.Media3AudioPlayerViewModel
import cn.spacexc.wearbili.remake.ui.player.videoplayer.defaultplayer.PARAM_IS_BANGUMI
...
import cn.spacexc.wearbili.remake.ui.player.videoplayer.defaultplayer.PARAM_VIDEO_ID
import cn.spacexc.wearbili.remake.ui.player.videoplayer.defaultplayer.PARAM_VIDEO_ID_TYPE
import cn.spacexc.wearbili.remake.ui.player.videoplayer.defaultplayer.VIDEO_TYPE_BVID
                    ...
                    .setContentIntent(
                        PendingIntent.getActivity(
                            ...
                            Intent(this, AudioPlayerActivity::class.java).apply {
                                putExtra(
                                    cn.spacexc.wearbili.remake.ui.video.info.ui.PARAM_VIDEO_ID_TYPE,
                                    videoIdType
                                )
                                putExtra(
                                    cn.spacexc.wearbili.remake.ui.video.info.ui.PARAM_VIDEO_ID,
                                    videoId
                                )
                                putExtra(
                                    cn.spacexc.wearbili.remake.ui.video.info.ui.PARAM_VIDEO_CID,
                                    videoCid
                                )
                                //putExtras(intent)
                            },
