...
data class Data(
    ...
    val floorInfo: List<cn.spacexc.wearbili.remake.ui.main.recommend.domain.remote.rcmd.web.FloorInfo>,
    @SerializedName("item")
    val item: List<cn.spacexc.wearbili.remake.ui.main.recommend.domain.remote.rcmd.web.Item>,
    @SerializedName("mid")
    val mid: Long,
