package cn.spacexc.wearbili.remake.ui.main.profile.detail.favorite.detail.domain
...
class FavoriteFolderDetailPagingSource(private val folderId: Long) : PagingSource<Int, Media>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Media> {
        ...
        val response =
            FavoriteInfo.getFavoriteFolderContentById(folderId = folderId, page = currentKey)
        if (response.code != 0) {
