package cn.spacexc.wearbili.remake.ui.player.videoplayer.defaultplayer
...
import cn.spacexc.wearbili.remake.ui.player.videoplayer.danmaku.DanmakuGetter
...
class Media3VideoPlayerViewModel @Inject constructor(
    ...
    private suspend fun loadSubtitleAndVideoChapters() {
        val response = VideoInfo.getVideoPlayerInfo(
            cn.spacexc.wearbili.remake.ui.video.info.ui.VIDEO_TYPE_AID,
