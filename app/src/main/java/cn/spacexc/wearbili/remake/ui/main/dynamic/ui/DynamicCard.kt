package cn.spacexc.wearbili.remake.ui.main.dynamic.ui
...
import cn.spacexc.wearbili.remake.ui.bangumi.info.ui.BANGUMI_ID_TYPE_EPID
import cn.spacexc.wearbili.remake.ui.main.dynamic.domain.remote.list.DynamicItem
import cn.spacexc.wearbili.remake.ui.main.dynamic.domain.remote.list.ItemRichTextNode
                                ...
                                BiliImage(
                                    ...
                                    modifier = when (imageList.size) {
                                        1 -> Modifier
                                            .fillMaxWidth()
                                            .clickVfx {
                                                onJumpToImage(imageList.map { it.src }, index)
                                                /*val intent =
