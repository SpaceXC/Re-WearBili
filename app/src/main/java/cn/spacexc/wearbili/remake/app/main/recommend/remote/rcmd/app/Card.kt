...
data class Card(
    val ad_tag: String,
    val ad_tag_style: cn.spacexc.wearbili.remake.app.main.recommend.remote.rcmd.app.AdTagStyle,
    val adver: cn.spacexc.wearbili.remake.app.main.recommend.remote.rcmd.app.Adver,
    ...
    val card_type: Int,
    val covers: List<cn.spacexc.wearbili.remake.app.main.recommend.remote.rcmd.app.Cover>,
    val desc: String,
    val duration: String,
    ...
    val feedback_panel: cn.spacexc.wearbili.remake.app.main.recommend.remote.rcmd.app.FeedbackPanel,
    val fold_time: Int,
    ...
    val video: cn.spacexc.wearbili.remake.app.main.recommend.remote.rcmd.app.Video
)