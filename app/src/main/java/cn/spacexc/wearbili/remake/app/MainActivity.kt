            ...
            SharedTransitionLayout {
                NavHost(navController = navController, startDestination = SplashScreen,
                    ...
                    composable<HomeScreen>(typeMap = mapOf(typeOf<Version?>() to parcelableType<Version?>())) {
                        ...
                        HomeScreen(
                            updateInfo = version?.let { Json.decodeFromString(version) },
                    ...
                    composable<SearchScreen> {
                        ...
                        SearchScreen(navController = navController, defaultSearchKeyword = default)
                    }
                    ...
                    composable<FollowingUsersScreen> {
                        FollowingUsersScreen(navController = navController)
                    }
                    ...
                    composable<VideoFavouriteFoldersScreen> {
                        ...
                        VideoFavouriteFoldersScreen(navController = navController, videoAid = aid)
                    }
                    ...
                    composable<CreateNewCacheScreen> {
                        ...
                        CreateNewCacheScreen(videoBvid = bvid, navController = navController)
                    }
                    ...
                    composable<ArticleScreen> {
                        ...
                        ArticleScreen(navController = navController, cvid = cvid)
                    }
