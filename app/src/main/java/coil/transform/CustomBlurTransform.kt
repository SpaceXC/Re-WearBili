...
class CustomBlurTransformation @JvmOverloads constructor(
    ...
    override val cacheKey = "${CustomBlurTransformation::class.java.name}-$radius-$sampling"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomBlurTransformation &&
